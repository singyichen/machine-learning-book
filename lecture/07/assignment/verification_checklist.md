...
驗證環境：`.venv`（Python 3.9 / scikit-learn 1.0.2 / joblib 1.5.3 / numpy 1.21.2 / matplotlib 3.5.3）

驗證對象：訓練程式、評估程式、模型檔、兩張圖、文字結果、九頁 PDF 報告與提交 ZIP
...
- [x] `515661055_陳欣怡_Assignment3_結果報告.pdf`（A4、9 頁）已逐頁渲染檢查，
